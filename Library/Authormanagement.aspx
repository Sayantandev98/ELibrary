<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Authormanagement.aspx.cs" Inherits="Library.Authormanagement" %>
        ...
        <div class="row">
            <div class="col-md-5">
                <div class="card">
                    ...
                    <div class="row">
                        <div class="col">
                            <center><img width="100px" src="images/writer.png" /></center>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">
                            ...
                            <div class="form-group">
                                <asp:TextBox CssClass="form-control" ID="AID" runat="server" placeholder="AuthorID"></asp:TextBox>
